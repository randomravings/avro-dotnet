...
namespace Schemas
{
    ...
    public class SchemaParseTest
    {
        ...
        /// <param name="avroString"></param>
        /// <param name="expectedToString"></param>
        [TestCase(
            typeof(NullSchema),
            @"null",
            @"null",
        ...
        [TestCase(
            typeof(UnionSchema),
            @"[{""type"": ""record"",""name"": ""Test"",""namespace"":""ns1"",""fields"": [{""name"": ""f"",""type"": ""long""}]},{""type"": ""record"",""name"": ""Test"",""namespace"":""ns2"",""fields"": [{""name"": ""f"",""type"": ""long""}]}]",
            @"union",
        ...
        [TestCase(
            ...
            @"org.apache.hadoop.avro.MyFixed",
