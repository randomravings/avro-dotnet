...
namespace Avro.Test.IO
{
    ...
    {
        private static readonly RecordSchema _SCHEMA = AvroParser.ReadSchema(@"{""name"":""Avro.Test.IO.TestRecord"",""type"":""record"",""fields"":[{""name"":""FieldA"",""type"":""int""},{""name"":""FieldB"",""type"":""string""},{""name"":""FieldC"",""type"":{""name"":""Avro.Test.IO.TestSubRecord"",""type"":""record"",""fields"":[{""name"":""FieldD"",""type"":""boolean""}]}},{""name"":""FieldX"",""type"":{""name"":""Avro.Test.IO.TestEnum"",""type"":""enum"",""symbols"":[""A"",""B"",""C""]}},{""name"":""TestFixed"",""type"":{""name"":""Avro.Test.IO.TestFixed"",""type"":""fixed"",""size"":40}}]}") as RecordSchema;
    ...
    {
        private static readonly RecordSchema _SCHEMA = AvroParser.ReadSchema(@"{""name"":""Avro.Test.IO.TestSubRecord"",""type"":""record"",""fields"":[{""name"":""FieldD"",""type"":""boolean""}]}") as RecordSchema;
    ...
    {
        private static readonly FixedSchema _SCHEMA = AvroParser.ReadSchema(@"{""name"":""Avro.Test.IO.TestFixed"",""type"":""fixed"",""size"":40}") as FixedSchema;
    ...
    {
        private static readonly RecordSchema _SCHEMA = AvroParser.ReadSchema(@"{""name"":""Avro.Test.IO.TestRecordWithDefault"",""type"":""record"",""fields"":[{""name"":""ID"",""type"":""int"",""default"":-1},{""name"":""Name"",""type"":""string""}]}") as RecordSchema;
    ...
    {
        private static readonly RecordSchema _SCHEMA = AvroParser.ReadSchema(@"{""name"":""Avro.Test.IO.TestRecordWithDefault"",""type"":""record"",""fields"":[{""name"":""ID"",""type"":""int""},{""name"":""Name"",""type"":""string""}]}") as RecordSchema;
    ...
    {
        private static readonly RecordSchema _SCHEMA = AvroParser.ReadSchema(@"{""name"":""Avro.Test.IO.TestRecordWithDefault"",""type"":""record"",""fields"":[{""name"":""Name"",""type"":""string""},{""name"":""Desc"",""type"":""string""}]}") as RecordSchema;
