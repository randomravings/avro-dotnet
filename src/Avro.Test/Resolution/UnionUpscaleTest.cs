...
namespace Avro.Test.IO
{
    ...
    public class UnionUpscaleTest<TWriter, SWriter, WUnionSchemaOne, WUnionSchemaTwo> where SWriter : AvroSchema, new() where WUnionSchemaOne : AvroSchema, new() where WUnionSchemaTwo : AvroSchema, new()
    {
        ...
        private readonly DatumReader<object> _specificReader;
    ...
    public class UnionUpscaleTimestampTest<SWriter, WUnionSchemaOne, WUnionSchemaTwo> : UnionUpscaleTest<DateTime, SWriter, WUnionSchemaOne, WUnionSchemaTwo> where SWriter : AvroSchema, new() where WUnionSchemaOne : AvroSchema, new() where WUnionSchemaTwo : AvroSchema, new()
    {
    ...
    public class UnionUpscaleTimeTest<SWriter, WUnionSchemaOne, WUnionSchemaTwo> : UnionUpscaleTest<TimeSpan, SWriter, WUnionSchemaOne, WUnionSchemaTwo> where SWriter : AvroSchema, new() where WUnionSchemaOne : AvroSchema, new() where WUnionSchemaTwo : AvroSchema, new()
    {
