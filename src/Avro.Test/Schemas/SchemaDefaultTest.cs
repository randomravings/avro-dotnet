    ...
    public class SchemaDefaultTest
    {
        ...
        class SchemaDefaults : IEnumerable
        {
            public IEnumerator GetEnumerator()
            {
                ...
                yield return new object[] { new EnumSchema("X", null, new string[] { "A", "B", "C" }), @"""C""" };
                yield return new object[] { new FixedSchema("X", null, 4), @"""\\u0000\\u0067\\u00A9\\u00FF""" };
                ...
                yield return new object[] { new RecordSchema("X", null,
                                                new RecordSchema.Field[]
                                                {
                                                    new RecordSchema.Field("f1", new IntSchema()),
                                                    new RecordSchema.Field("f2", new StringSchema()) { Default = @"""ABC""" }
                                                }
                                            ),
                                            @"{ ""f1"": 123 }"
                };
        ...
        class SchemaErrorDefaults : IEnumerable
        {
            public IEnumerator GetEnumerator()
            {
                ...
                yield return new object[] { new EnumSchema("X", null, new string[] { "A", "B", "C" }), @"22" };
                yield return new object[] { new EnumSchema("X", null, new string[] { "A", "B", "C" }), @"""X""" };
                yield return new object[] { new FixedSchema("X", null, 3), @"123" };
                yield return new object[] { new FixedSchema("X", null, 3), @"""\\u0000\\u0067\\u00A9\\u00FF""" };
                ...
                yield return new object[] { new RecordSchema("X", null,
                                                ...
                                                {
                                                    new RecordSchema.Field("f1", new IntSchema()),
                                                    new RecordSchema.Field("f2", new StringSchema())
                                                }
                                            ),
                                            @"{ ""f1"": 123 }"
                };
