...
namespace Avro.Test.Generic
{
    ...
    public class GenericUnionUpscaleTest<TWriter, SWriter, WUnionSchemaOne, WUnionSchemaTwo> where SWriter : AvroSchema, new() where WUnionSchemaOne : AvroSchema, new() where WUnionSchemaTwo : AvroSchema, new()
    {
    ...
    public class GenericUnionUpscaleTimestampTest<SWriter, WUnionSchemaOne, WUnionSchemaTwo> : GenericUnionUpscaleTest<DateTime, SWriter, WUnionSchemaOne, WUnionSchemaTwo> where SWriter : AvroSchema, new() where WUnionSchemaOne : AvroSchema, new() where WUnionSchemaTwo : AvroSchema, new()
    {
    ...
    public class GenericUnionUpscaleTimeTest<SWriter, WUnionSchemaOne, WUnionSchemaTwo> : GenericUnionUpscaleTest<TimeSpan, SWriter, WUnionSchemaOne, WUnionSchemaTwo> where SWriter : AvroSchema, new() where WUnionSchemaOne : AvroSchema, new() where WUnionSchemaTwo : AvroSchema, new()
    {
