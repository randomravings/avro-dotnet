...
namespace Avro.Test.Generic
{
    ...
    public class GenericPromoted<TWriter, TReader, SWriter, SReader> where SWriter : AvroSchema, new() where SReader : AvroSchema, new()
    {
    ...
    public class GenericPrimitiveMirrored<T, S> : GenericPromoted<T, T, S, S> where S : AvroSchema, new()
    {
    ...
    public class GenericDateTimeMirrored<S> : GenericPrimitiveMirrored<DateTime, S> where S : AvroSchema, new()
    {
    ...
    public class GenericTimeSpanMirrored<S> : GenericPrimitiveMirrored<TimeSpan, S> where S : AvroSchema, new()
    {
    ...
    public class GenericUuidMirrored<S> : GenericPrimitiveMirrored<Guid, S> where S : AvroSchema, new()
    {
    ...
    public class GenericDurationMirrored<S> : GenericPrimitiveMirrored<AvroDuration, S> where S : AvroSchema, new()
    {
    ...
    public class GenericDateTimePromoted<SWriter, SReader> : GenericPromoted<DateTime, DateTime, SWriter, SReader> where SWriter : AvroSchema, new() where SReader : AvroSchema, new()
    {
    ...
    public class GenericTimeSpanPromoted<SWriter, SReader> : GenericPromoted<TimeSpan, TimeSpan, SWriter, SReader> where SWriter : AvroSchema, new() where SReader : AvroSchema, new()
    {
