...
namespace Avro.Test.Specific
{
    ...
    public class SpecificUnionUpscaleTest<TWriter, SWriter, WUnionSchemaOne, WUnionSchemaTwo> where SWriter : Schema, new() where WUnionSchemaOne : Schema, new() where WUnionSchemaTwo : Schema, new()
    {
    ...
    public class SpecificUnionUpscaleTimestampTest<SWriter, WUnionSchemaOne, WUnionSchemaTwo> : SpecificUnionUpscaleTest<DateTime, SWriter, WUnionSchemaOne, WUnionSchemaTwo> where SWriter : Schema, new() where WUnionSchemaOne : Schema, new() where WUnionSchemaTwo : Schema, new()
    {
    ...
    public class SpecificUnionUpscaleTimeTest<SWriter, WUnionSchemaOne, WUnionSchemaTwo> : SpecificUnionUpscaleTest<TimeSpan, SWriter, WUnionSchemaOne, WUnionSchemaTwo> where SWriter : Schema, new() where WUnionSchemaOne : Schema, new() where WUnionSchemaTwo : Schema, new()
    {
